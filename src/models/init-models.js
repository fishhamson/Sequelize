...
import _type_food from  "./type_food.js";
...
export default function initModels(sequelize) {
  ...
  const type_food = _type_food.init(sequelize, DataTypes);
  ...
  food.belongsTo(type_food, { as: "type", foreignKey: "type_id"});
  type_food.hasMany(food, { as: "foods", foreignKey: "type_id"});
